...
void gen_sieve_primes()
{
    ...
    {
        /*if(primes[p] == true) // it is not multiple of any other prime
            primes[p] = true;*/ // mark it as prime
...
void Knock_Multiples_Of_FirstArg_from_SecondArgArray(int y, bool *array, int size,int start)
{
	...
	//<<"value of arr[2] "<<array[2]<<"at y="<<y<<endl;
	// if (i < size)
	// {
	// 	for (int c = 0; i+ c*y < size; ++c)
	// 	{
	// 		if (array[i+ c*y] != y)
	// 		{
	// 			array[i+ c*y] = 1;			}
